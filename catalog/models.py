...
class Product(models.Model):
    name = models.CharField(max_length=100, verbose_name="Наименование", help_text="Введите наименование")
    description = models.TextField(verbose_name= "Описание")
    image = models.ImageField(upload_to="catalog/product_photo", verbose_name="Изображение",null = True,blank =True)
    ...
    price = models.CharField(max_length=50, verbose_name="Цена за покупку", help_text="Введите цену за покупку",null = True,blank =True)
